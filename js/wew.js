...
wew.prototype.getSet = function(setName, callback) {'use strict';
...
}, wew.prototype.getCap = function(capabilityName, callback) {'use strict';
	...
	var xmlhttpmethod = false, attempts = [
	function() {
